...
public class TeamRegistrationRequest {
    ...
    @Pattern(regexp = "[a-zA-Z0-9\\s]{2,30}", message = "The team name can only include uppercase and lowercase letters of the English alphabet and numbers and length must be between 2 and 30 character")
